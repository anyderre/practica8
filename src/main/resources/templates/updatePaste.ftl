                    ...
                    <div class="col-md-offset col-md-7">
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control"  name="bloqueDeTexto" id="bloqueDeTexto" cols="50"
                                      rows="20" required>${paste.getBloqueDeCodigo()}</textarea>
                        </div>
                    </div>
                    <div class="col-md-5">
                        <div class="form-group" style="margin-top:77px">
                            <label for="syntax">Syntax</label>
                            <select class="form-control" name="syntax" id="syntax" required>
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control" name="expirationDate" id="expirationDate" required>
                                <option selected disabled>Select One</option>
                                <option>never</option>
                            ...
                            <div class="form-group">
                                ...
                                <select class="form-control" name="expositionType" id="expositionType" required>
                                    <option selected disabled>Select One</option>
