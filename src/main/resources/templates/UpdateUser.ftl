                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="nombre" name="name" max="100" pattern="[A-Za-z].{2,}" value="${usuarioUpdate.getName()}"/>
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="form-group">
                            <label for="username">Username</label>
                            <input type="text" id="username" name="username" readonly class="form-control" pattern="[A-Za-z].{2,}" value="${usuarioUpdate.getUsername()}">
                        </div>
                    </div>
                </div>
                <div class="row">
                    ...
                    <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" max="100" pattern="[A-Za-z].{4,}" id="occupation" name="occupation">
                            </div>
                    </div>
                </div>
