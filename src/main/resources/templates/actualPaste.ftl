...
<div class="container">
    ...
    <#if paste.getLatitude()??>
        <p id="lat" style="display: none">${paste.getLatitude()}</p>
        <p id="lng" style="display: none">${paste.getLongitud()}</p>

        <div class="col-md-6">
            <button class="btn btn-primary" id="getPosition">Save Paste Offline
            </button>
            <p id="mapholder"></p>
        </div>
    </#if>
